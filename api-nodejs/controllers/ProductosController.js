...
const crearProducto = () => {
    ...
    Producto.create({
        ...
        categoria: 'Celulares',
        precio: 305000,
        descripcion: 'iPhone 13 Pro Max. El mayor avance en el sistema de cámaras Pro hasta ahora. Pantalla Super Retina XDR con ProMotion que brinda una respuesta más rápida y fluida. Chip A15 Bionic para un rendimiento fuera de serie. Diseño resistente y la mayor duración de batería jamás vista en un iPhone.',
        color: 'plata',
        marca: 'Apple',
        bateria: '4000 ma',
    ...
    Producto.create({
        ...
        categoria: 'Celulares',
        precio: 75000,
        descripcion: 'El Xiaomi Redmi Note 10 Pro es el líder de la décima reencarnación de la serie Redmi Note. Con una pantalla Super AMOLED de 6.43 pulgadas a resolución Full HD+, el Redmi Note 10 está potenciado por un procesador Snapdragon 678 con 4GB de memoria RAM con opciones de 64GB o 128GB de almacenamiento interno expandible vía microSD. La cámara posterior del Redmi Note 10 es cuádruple, en configuración 48MP+ 8MP + 2MP + 2MP, mientras que la cámara selfie es de 13 megapixels. Entre el resto de las características se destacan unos parlantes stereo, batería de 5000 mAh de carga rápida, resistencia al agua IP53 y corre MIUI 12 basado en Android 11.',
        color: 'gris',
        marca: 'Xiaomi',
        bateria: '5000 ma',
        almacenamiento: '128 gb',
    ...
    Producto.create({
        ...
        categoria: 'Relojes',
        precio: 5500,
        descripcion: 'Con 10 años de trayectoria, Xiaomi se posiciona como uno de los líderes indiscutidos en el mercado de los smartwatches. Sus productos se destacan por la calidad, el diseño sencillo y muy buenas prestaciones. La Mi Band tiene todo lo necesario para acompañarte en tu rutina.',
        color: 'negro',
        marca: 'Xiaomi',
        bateria: '250 ma',
        almacenamiento: '2 gb',
